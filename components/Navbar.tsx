    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden lg:flex items-center gap-2">
          <span className={`text-xs font-extrabold px-3 py-1 rounded-lg border ${roleLabels[effectiveRole].badgeColor} flex items-center gap-1.5 shadow-xs`}>
            <Sparkles className="h-3.5 w-3.5" />
            {roleLabels[effectiveRole].title}
          </span>
          {effectiveRole === 'CEO' && (
