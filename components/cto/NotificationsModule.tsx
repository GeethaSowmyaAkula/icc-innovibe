      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Provide the CTO with intelligent technology alerts, important communications, approvals, and priority actions across InnoVibe Mobility systems.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button onClick={() => alert('Opening Pending CTO Approval Queue...')} className="px-3 py-1.5 rounded-xl bg-purple-600 text-white text-xs font-bold flex items-center gap-1.5 shadow-xs hover:bg-purple-700">
            <CheckSquare className="h-4 w-4" /> Approval Queue (5)
          </button>
          <button onClick={() => alert('Clearing Read Executive Notifications...')} className="px-3 py-1.5 rounded-xl bg-white text-slate-700 text-xs font-bold border border-slate-200 flex items-center gap-1.5 hover:bg-slate-50">
            Clear Read Alerts
          </button>
        </div>
      </div>
